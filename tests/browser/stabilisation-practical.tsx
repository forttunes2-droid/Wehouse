...
function Fixture(){
 ...
 {mode==='split'&&!group&&<><p className="text-sm leading-6">Short Let reservation · review before payment</p><ShortLetSplitCosts userId="qa-owner" row={{id:'reservation-existing',stay_type:'short_let',status:'payment_pending',guest_count:3,stay_rent_total:1000,security_deposit_snapshot:500,rent_payment_status:'unpaid',stay_check_in:'2027-03-20',stay_check_out:'2027-03-21'}} onCreated={item=>{w.__createdGroup=item;setGroup(item.id);}}/></>}
