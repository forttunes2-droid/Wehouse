      ...
      {!loading && notifs.length === 0 && (
        <div className="text-center py-8">
          ...
          <p className="text-[10px] text-[#5C5E72]/70 mt-1">
            Notifications appear here when something happens
          </p>
        </div>
      )}
          ...
          >
            <div className="flex items-start gap-2.5">
              ...
              <div className="flex-1 min-w-0">
                <p
                  className={`text-xs ${n.read ? "text-[#8A8B9C]" : "text-white font-medium"}`}
                >
                  {n.title}
                </p>
                <p className="text-[10px] text-[#5C5E72] mt-0.5">{n.message}</p>
