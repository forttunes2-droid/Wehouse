// ═══════════════════════════════════════════════════════════════
// DESKTOP LAYOUT — Pure CSS Responsive
// Uses Tailwind responsive prefixes, no JS window checks
// Desktop: Sidebar + Header + Wide content grid
// Mobile: Hidden sidebar, existing bottom nav preserved
// ═══════════════════════════════════════════════════════════════
    ...
    <div className="min-h-[100dvh] bg-[#0A0A0F] flex">
      ...
      >
        ...
        <div className="h-16 flex items-center px-4 border-b border-white/[0.04]">
          ...
          {!collapsed && <span className="ml-3 text-sm font-bold text-white whitespace-nowrap">WeHouse</span>}
          <button
      ...
      {/* ═══ MAIN CONTENT ═══ */}
      <div className={`flex-1 flex flex-col min-h-[100dvh] lg:ml-[240px] transition-all duration-300 ${collapsed ? 'lg:!ml-[72px]' : ''}`}>
        {/* Top Header — Desktop only */}
        <header className="hidden lg:flex items-center justify-between h-14 px-6 border-b border-white/[0.04] bg-[#0A0A0F]/80 backdrop-blur-xl sticky top-0 z-30">
