export default function WorkerTrustBadge({ trusted = false }: { trusted?: boolean }) {
  ...
  return (
    <span
      ...
      className="inline-flex shrink-0 items-center gap-1 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-2.5 py-1 text-[9px] font-semibold text-emerald-300"
    >
