...
export default function HousingOperationsWorkspace() {
  ...
  return <div className="space-y-5">
    ...
    <section className="rounded-2xl border border-blue-500/10 bg-blue-500/[.03] p-4">
      <p className="text-[9px] font-semibold uppercase tracking-[.14em] text-blue-300">Verify arrival</p>
