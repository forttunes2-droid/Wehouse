...
export default function HousingOperationsWorkspace() {
  ...
  return <div className="space-y-5">
    <div><h3 className="text-base font-bold">Live housing operations</h3><p className="mt-1 text-[10px] leading-5 text-[#707687]">Operational property states come from reservation and tenancy workflows. Staff cannot manually label a property Reserved or Occupied.</p></div>
...
function HousingCase({ row, back }: { row: any; back: () => void }) {
  ...
  const canMoveIn = row.current_reservation_id && ['reserved','inspection_pending','ready_for_move_in'].includes(row.reservation_status) && row.reservation_fee_paid;
