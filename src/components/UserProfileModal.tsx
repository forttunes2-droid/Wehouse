...
const STAFF_MODULES:Array<[StaffModule,string]>=[['operations','Property Operations'],['finance','Finance'],['support','Human Support'],['security','Security Operations'],['verification','Worker Operations'],['field_officer','Field Operations']];
