...
export default function CreatorAuditWorkspace(){
 ...
 return <div className="space-y-5">
  <section className="rounded-3xl border border-violet-500/15 bg-gradient-to-br from-violet-500/[.09] via-[#11141D] to-[#0D1017] p-5 sm:p-6">
   ...
   <p className="mt-2 max-w-2xl text-[10px] leading-relaxed text-[#747A8B]">Read-only history from the database. Settings are changed only in Creator Settings; this page records when a setting, team assignment or operational decision was previously changed.</p>
  </section>
  <section className="rounded-2xl border border-amber-500/15 bg-amber-500/[.04] p-4"><p className="text-[10px] font-semibold text-amber-200">Why older entries appear</p><p className="mt-1 text-[9px] leading-5 text-[#8A8290]">History includes earlier setup and testing actions performed through the Creator account. An entry does not mean the app changed a value by itself, and nothing on this page can change a setting.</p></section>
