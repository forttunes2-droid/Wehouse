...
export default function WorkerVerificationChecklist({ identityPassed, paymentConfirmed, skillVideoSaved, paymentRequired = true }: Props) {
  const items = [
    { label: 'Private face check', done: identityPassed },
    { label: paymentRequired ? 'Onboarding fee' : 'Free onboarding', done: paymentConfirmed },
