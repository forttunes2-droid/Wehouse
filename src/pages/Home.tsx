      ...
      <div className="relative h-[500px] overflow-hidden z-[1]">
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-5 pt-8">
          ...
          <div className="mt-auto pb-4">
            ...
            {/* Search bar — ALL roles can browse listings */}
            ...
            {/* Non-user role banner — shows dashboard shortcut */}
            {!isUser && (
              <button onClick={() => dashboardPage && onNavigate(dashboardPage)} className="w-full mt-3 h-10 rounded-xl bg-violet-500/10 border border-violet-500/20 text-violet-400 text-xs font-medium flex items-center justify-center gap-2 hover:bg-violet-500/20 transition-colors">
        ...
        <div className="relative rounded-3xl overflow-hidden h-[200px]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-5">
            ...
            <div className="flex gap-3">
              ...
              {!isUser && (
                <button onClick={() => dashboardPage && onNavigate(dashboardPage)} className="h-10 px-5 rounded-xl bg-white/10 border border-white/20 text-white text-xs font-semibold hover:bg-white/20 transition-colors inline-flex items-center gap-2">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /><polyline points="9 22 9 12 15 12 15 22" /></svg>
                  Dashboard
                </button>
              )}
