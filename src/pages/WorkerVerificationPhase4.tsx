    ...
    <Screen>
      ...
      <header className="border-b border-white/[.06] bg-[#0A0A0F] px-4 py-4">
        <div className="mx-auto flex max-w-2xl items-center gap-3">
          ...
          <div className="min-w-0 flex-1"><p className="text-[9px] font-bold tracking-[.18em] text-violet-300">WEHOUSE · WORKER</p><h1 className="mt-1 text-lg font-bold">Work verification</h1></div>
        </div>
      </header>
