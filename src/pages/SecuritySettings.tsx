...
export default function SecuritySettings({profile,onBack}:Props){
  ...
  return <AccountShell profile={profile} title="Security" description="Password, sign-ins and account protection." onBack={onBack}>
