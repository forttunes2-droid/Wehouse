...
type PropertySearchState={stayType:HomeStayType;priceMin:number|'';priceMax:number|'';bedrooms:number|'';filterState:string;filterCity:string};
let searchState:PropertySearchState={stayType:'long_stay',priceMin:'',priceMax:'',bedrooms:'',filterState:'',filterCity:''};
...
export default function Search({onNavigate,savedIds,onToggleSave}:SearchProps){
 ...
 function clearFilters(){setPriceMin('');setPriceMax('');setBedrooms('');setFilterState('');setFilterCity('')}
 function chooseStay(next:HomeStayType){if(next===stayType)return;setStayType(next);setPriceMin('');setPriceMax('')}
