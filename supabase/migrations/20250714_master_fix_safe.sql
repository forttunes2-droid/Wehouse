...
--    Filters by email and username since user_id column may not exist
-- ═══════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════
-- 3. Add file columns to messages (if not already added)
-- ═══════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════
-- 4. RPC: Start partner INSPECTION chat (violet button)
...
-- ═══════════════════════════════════════════════════════════════
-- 5. RPC: Start general support chat (users/workers complaints)
-- ═══════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════
-- 6. RPC: Get inspection chats (staff view)
-- ═══════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════
-- 7. RPC: Get general support chats (staff view)
-- ═══════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════
-- 8. RPC: Get ALL support inbox (for Creator Dashboard Support tab)
-- ═══════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════
-- 9. NOTIFICATIONS: Create table (if not exists)
-- ═══════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════
-- 11. SERVICE CATEGORIES: RLS policies for CRUD
-- ═══════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════
-- 12. RPC: Delete service category (cascades to subcategories)
-- ═══════════════════════════════════════════════════════════════
