...
-- Phase 4 external KYC owns government identity verification. Workers should no
-- longer have any browser-accessible Storage policy for raw government-ID files.
