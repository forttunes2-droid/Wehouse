-- Keep Property Partner updates tied only to what the partner needs to know.
-- Long Let is about confirmed rent and move-in readiness. Short Let is a
-- separate booked/check-in/check-out lifecycle.
