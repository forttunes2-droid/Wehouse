-- WEHOUSE: STORAGE BUCKETS + POLICIES + ALL FUNCTIONS
-- Run this ENTIRE file in your Supabase SQL Editor

-- ================================================================
-- PART 0: STORAGE BUCKETS (fixes "unable to load bucket")
-- ================================================================

-- listing-videos: for property video uploads (50MB max)
...
-- worker-files: for worker verification videos/docs (100MB max)
INSERT INTO storage.buckets (id, name, public, avif_autodetection, file_size_limit, allowed_mime_types)
...
-- chat-files: for chat attachments (25MB max)
INSERT INTO storage.buckets (id, name, public, avif_autodetection, file_size_limit, allowed_mime_types)
...
-- Policies (drop first to avoid duplicates, then create)
