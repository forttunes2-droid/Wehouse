-- ═══════════════════════════════════════════════════════════════
-- WEHOUSE COMPLETE FIX — Run this entire file
-- Fixes: field officer inspections, worker profile, roommate matches, SQL type errors
-- ═══════════════════════════════════════════════════════════════

-- ================================================================
-- 1. FIX: get_my_inspections with proper type casting
-- ================================================================
...
AS $$
  ...
  LEFT JOIN public.listings l ON l.id::text = uir.listing_id::text
...
-- ================================================================
-- 2. FIX: update_inspection_status with proper casting
-- ================================================================
...
-- ================================================================
-- 3. FIX: post_property_from_inspection
-- ================================================================
...
-- ================================================================
-- 4. FIX: worker_update_profile (critical — worker edits go pending)
-- ================================================================
...
-- ================================================================
-- 5. FIX: find_roommate_matches (was missing entirely!)
-- ================================================================
...
BEGIN
  ...
  WHERE p.user_id != p_user_id
    ...
    AND NOT EXISTS (
      ...
      WHERE rsr.searcher_id = p_user_id AND rsr.matched_user_id = p.user_id
    )
...
-- ================================================================
-- 8. Fix admin_get_field_officers
-- ================================================================
